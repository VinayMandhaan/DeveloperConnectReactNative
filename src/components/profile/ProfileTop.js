...
const ProfileTop = ({profile : {status,company,location,website,social, githubusername, user:{name,avatar}}}) => {
    return (
        <>
        
        <ScrollView>
        <ImageBackground source={require('../../assets/Images/Code3.jpg')} style={{width:'100%', height:250}}>
